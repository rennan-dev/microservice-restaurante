...
public class RestauranteController : ControllerBase
{
    ...
    private IRabbitMQ _rabbitMqClient;

    public RestauranteController(IRestauranteRepository repository, IMapper mapper, IItemServiceHttpClient itemServiceHttpClient, IRabbitMQ rabbitMqClient) {
